package br.com.cleo.loja.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.com.cleo.loja.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.com.cleo.loja.repository.UserRepository.USERS_BY_EMAIL_CACHE);
