...
/**
 * REST controller for managing {@link br.com.cleo.loja.domain.Produto}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ProdutoResource {
    ...
    public ProdutoResource(ProdutoRepository produtoRepository, ProdutoSearchRepository produtoSearchRepository) {
    ...
    public ResponseEntity<Produto> createProduto(@RequestBody Produto produto) throws URISyntaxException {
        ...
        produtoSearchRepository.index(result);
    ...
    public ResponseEntity<Produto> partialUpdateProduto(
        ...
        Optional<Produto> result = produtoRepository
            ...
            .map(savedProduto -> {
                produtoSearchRepository.save(savedProduto);
    ...
    public List<Produto> searchProdutos(@RequestParam String query) {
        ...
        return StreamSupport.stream(produtoSearchRepository.search(query).spliterator(), false).collect(Collectors.toList());
    }
}
