...
/**
 * REST controller for managing {@link br.com.cleo.loja.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class UsuarioResource {
    ...
    public ResponseEntity<Usuario> createUsuario(@RequestBody Usuario usuario) throws URISyntaxException {
        ...
        usuarioSearchRepository.index(result);
    ...
    public ResponseEntity<Usuario> partialUpdateUsuario(
        ...
        Optional<Usuario> result = usuarioRepository
            ...
            .map(savedUsuario -> {
                usuarioSearchRepository.save(savedUsuario);
    ...
    public List<Usuario> searchUsuarios(@RequestParam String query) {
        ...
        return StreamSupport.stream(usuarioSearchRepository.search(query).spliterator(), false).collect(Collectors.toList());
    }
}
